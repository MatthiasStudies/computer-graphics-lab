...
public:
    ...
    Triangle(Vector<FLOAT, N> a, Vector<FLOAT, N> b, Vector<FLOAT, N> c, Vector<FLOAT, N> na, Vector<FLOAT, N> nb,
             Vector<FLOAT, N> nc);
    ...
    bool intersects(const Ray<FLOAT, N>& ray, Vector<FLOAT, N>& normal, Vector<FLOAT, N>& intersection, FLOAT& u,
