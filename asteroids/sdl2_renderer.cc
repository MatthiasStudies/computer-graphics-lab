...
void SDL2Renderer::render(Saucer* saucer)
{
  static SDL_Point saucer_points[] = {
    {-16, -6}, {16, -6}, {40, 6}, {-40, 6}, {-16, 18}, {16, 18},
...
void SDL2Renderer::render(SpaceshipDebris* debris)
{
  ...
  static std::array<Vector2df, 6> debris_direction = {
    Vector2df{-40, -23}, Vector2df{50, 15}, Vector2df{0, 45},
...
{
  static SDL_Point debris_points[] = {
    {-32, 32}, {-32, -16}, {-16, 0}, {-16, -32}, {-8, 24}, {8, -24}, {24, 32}, {24, -24}, {24, -32}, {32, -8}
  };
